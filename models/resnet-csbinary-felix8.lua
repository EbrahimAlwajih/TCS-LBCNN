...
require 'cunn'
require 'cutorch'
require 'RandomCSBinaryConvolution8'

local RandomCSBinaryConvolution8 = cudnn.RandomCSBinaryConvolution8
...
local function createModel(opt)   
   local function basicblock(nChIn,nChOut,sz)
      ...
      local shareConv = RandomCSBinaryConvolution8(nChIn,nChOut,sz,sz,1,1,(sz-1)/2,(sz-1)/2)
