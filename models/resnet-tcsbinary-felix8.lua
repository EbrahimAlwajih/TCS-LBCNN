...
require 'cunn'
require 'cutorch'
require 'RandomTCSBinaryConvolution8'

local RandomTCSBinaryConvolution8 = cudnn.RandomTCSBinaryConvolution8
...
local function createModel(opt)   
   local function basicblock(nChIn,nChOut,sz)
      ...
      local shareConv = RandomTCSBinaryConvolution8(nChIn,nChOut,sz,sz,1,1,(sz-1)/2,(sz-1)/2)
