...
require 'cunn'
require 'cutorch'
require 'RandomBinaryConvolution8'

local RandomBinaryConvolution8 = cudnn.RandomBinaryConvolution8
...
local function createModel(opt)   
   local function basicblock(nChIn,nChOut,sz)
      ...
      local shareConv = RandomBinaryConvolution8(nChIn,nChOut,sz,sz,1,1,(sz-1)/2,(sz-1)/2)
