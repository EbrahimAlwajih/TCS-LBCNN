...
local M = {}
local DBILINGUALDataset = torch.class('resnet.DBILINGUALDataset', M)

function DBILINGUALDataset:__init(imageInfo, opt, split)
...
function DBILINGUALDataset:get(i)
