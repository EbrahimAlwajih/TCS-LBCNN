...
require 'cunn'
require 'cutorch'
require 'RandomCSBinaryConvolution'

local RandomCSBinaryConvolution = cudnn.RandomCSBinaryConvolution
...
local function createModel(opt)   
   local function basicblock(nChIn,nChOut,sz)
      ...
      local shareConv = RandomCSBinaryConvolution(nChIn,nChOut,sz,sz,1,1,(sz-1)/2,(sz-1)/2)
