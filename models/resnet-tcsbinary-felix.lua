...
require 'cunn'
require 'cutorch'
require 'RandomTCSBinaryConvolution'

local RandomTCSBinaryConvolution = cudnn.RandomTCSBinaryConvolution
...
local function createModel(opt)   
   local function basicblock(nChIn,nChOut,sz)
      ...
      local shareConv = RandomTCSBinaryConvolution(nChIn,nChOut,sz,sz,1,1,(sz-1)/2,(sz-1)/2)
